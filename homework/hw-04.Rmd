...
1. Consider the lists `animals = ["penguins", "turtles", "dragons"]` and `foods = ["sandwiches", "ice cream", "tacos"]`. Use two for loops, one nested within another, and assigning the variables to take the *values* of the lists, to print the full set of sentence combinations of the form `"penguins love sandwiches", "penguins love ice cream", ..., "dragons love tacos".
