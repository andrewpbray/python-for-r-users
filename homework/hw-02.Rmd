...
1. We saw that in Python it is possible to concatenate and replicate strings using arithmetic operators. Do the update assignment operators also work on strings? Try it.
