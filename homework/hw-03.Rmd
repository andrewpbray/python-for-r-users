...
1. Consider the following list of strings:
    ...
    1. Construct one additional list comprehension that uses a string method of your choice and asserts a logical condition for the operation using the `if` keyword.

1. One of the most common places that you'll find object-oriented programming in R is in print methods. Any time you type the name of a variable at the console, it often doesn't actually print out the value of that object, but rather calls on its particular print method.
    ...
    1. Create a ggplot object and save it as `p1`. Answer the same questions as above for `p1`. What command would you use to pull up the help file for the print method of a ggplot?
